declare module "_pgn-parser" {
    const _exports: any;
    export = _exports;
}
declare module "split-games" {
    export const split: (input: any, options: any) => any[];
}
declare module "types" {
    ...
    export type SevenRoosterTags = {
        [key in SevenRoosterTagKeys]: string;
    } & {
        Date?: PgnDate;
    };
    export type PlayerTagKeys = 'WhiteTitle' | 'BlackTitle' | 'WhiteElo' | 'BlackElo' | 'WhiteUSCF' | 'BlackUSCF' | 'WhiteNA' | 'BlackNA' | 'WhiteType' | 'BlackType';
    ...
    export type LichessTagKeys = 'PuzzleEngine' | 'PuzzleMakerVersion' | 'PuzzleCategory' | 'PuzzleWinner' | 'Variant' | 'WhiteRatingDiff' | 'BlackRatingDiff' | 'WhiteFideId' | 'BlackFideId' | 'WhiteTeam' | 'BlackTeam';
    export type ClockTagKeys = 'Clock' | 'WhiteClock' | 'BlackClock';
    export type TagKeys = SevenRoosterTagKeys | PlayerTagKeys | EventTagKeys | OpeningTagKeys | AlternativeStartingKeys | GameConclusionTagKeys | MiscTagKeys | LichessTagKeys | ClockTagKeys;
...
declare module "pgn-parser" {
    import { ParseTreeOrArray, PgnOptions } from "types";
    /**
