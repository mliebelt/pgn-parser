...
(function (root, factory) {
    ...
    function peg$parse(input, options) {
        ...
        var peg$f72 = function (cm, mn, hm, nag, ca, vari, all) {
            var arr = (all ? all : []);
            var move = {};
            move.moveNumber = mn;
            move.notation = hm;
        ...
        var peg$f92 = function (cf, cfl) { var arr = []; arr.push(cf); for (var i = 0; i < cfl.length; i++) {
            arr.push(cfl[i][2]);
        } ; return arr; };
        ...
        var peg$f104 = function (hm, s1, s2, millis) {
            let ret = s1;
            if (!hm) {
        ...
        var peg$f105 = function (hm, s1, s2) {
            let ret = s1;
            if (!hm) {
                addMessage({ message: `Hours and minutes missing` });
            }
        ...
        var peg$f106 = function (hours, minutes) {
            if (!minutes) {
        ...
        var peg$f113 = function (fig, disc, str, col, row, pr, ch) {
            var hm = {};
            hm.fig = (fig ? fig : null);
        ...
        var peg$f114 = function (fig, cols, rows, str, col, row, pr, ch) {
            var hm = {};
            hm.fig = (fig ? fig : null);
        ...
        var peg$f115 = function (fig, str, col, row, pr, ch) {
            var hm = {};
            hm.fig = (fig ? fig : null);
            hm.strike = (str ? str : null);
            hm.col = col;
...
System.register("split-games", [], function (exports_1, context_1) {
    "use strict";
    var normalizeLineEndings, split;
    var __moduleName = context_1 && context_1.id;
    return {
        setters: [],
        execute: function () {
            normalizeLineEndings = (str, normalized = '\n') => str.replace(/\r?\n/g, normalized);
            exports_1("split", split = function (input, options) {
...
System.register("pgn-parser", ["_pgn-parser"], function (exports_3, context_3) {
    "use strict";
    var parser;
...
System.register("index", ["split-games", "pgn-parser"], function (exports_4, context_4) {
    "use strict";
    var __moduleName = context_4 && context_4.id;
    return {
        setters: [
            function (split_games_1_1) {
                exports_4({
                    "split": split_games_1_1["split"]
                });
            },
            function (pgn_parser_1_1) {
                exports_4({
                    "parse": pgn_parser_1_1["parse"]
                });
            }
        ],
        execute: function () {
