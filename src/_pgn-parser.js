...
(function(root, factory) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$f63 = function(res) { if (!res) { addMessage({ message: "Tag TimeControl has to have a value" }); return ""; }
          return res; };
    ...
    var peg$f68 = function(moves, seconds) { return { kind: 'movesInSeconds', moves: moves, seconds: seconds }; };
    var peg$f69 = function(seconds, incr) { return { kind: 'increment', seconds: seconds, increment: incr }; };
    var peg$f70 = function(seconds) { return { kind: 'suddenDeath', seconds: seconds }; };
    var peg$f71 = function(seconds) { return { kind: 'hourglass', seconds: seconds }; };
    var peg$f72 = function(res) { return res; };
    var peg$f73 = function(res) {return res; };
    var peg$f74 = function(v) { return v };
    var peg$f75 = function() {return 0 };
    var peg$f76 = function() { addMessage({ message: 'Use "-" for an unknown value'}); return 0 };
    var peg$f77 = function(digits) { return makeInteger(digits); };
    var peg$f78 = function(cm, mn, hm, nag, dr, ca, vari, all) { var arr = (all ? all : []);
          ...
          move.commentDiag = ca;
          return arr; };
    var peg$f79 = function(e) {return e; };
    var peg$f80 = function(eg) { return [eg]; };
    var peg$f81 = function(cf, c) { return c };
    var peg$f82 = function(cf, cfl) { return merge([cf].concat(cfl)) };
    var peg$f83 = function(cm) { return cm;};
    var peg$f84 = function(cm) { return { comment: cm}; };
    var peg$f85 = function(cf, ic) { return ic };
    var peg$f86 = function(cf, tail) { return merge([{ colorFields: cf }].concat(tail[0])) };
    var peg$f87 = function(ca, ic) { return ic };
    var peg$f88 = function(ca, tail) { return merge([{ colorArrows: ca }].concat(tail[0])) };
    var peg$f89 = function(cc, cv, ic) { return ic };
    var peg$f90 = function(cc, cv, tail) { var ret = {}; ret[cc]= cv; return merge([ret].concat(tail[0])) };
    var peg$f91 = function(ev, ic) { return ic };
    var peg$f92 = function(ev, tail) { var ret = {};  ret["eval"]= parseFloat(ev); return merge([ret].concat(tail[0])) };
    var peg$f93 = function(ac, val, ic) { return ic };
    var peg$f94 = function(ac, val, tail) { var ret = {}; ret[ac]= val.join(""); return merge([ret].concat(tail[0])) };
    var peg$f95 = function(c, ic) { return ic };
    var peg$f96 = function(c, tail) { if (tail.length > 0) { return merge([{ comment: trimEnd(c.join("")) }].concat(trimStart(tail[0]))) }
            else { return { comment: c.join("") } } };
    var peg$f97 = function(cm) { return cm.join(""); };
    var peg$f98 = function(cf, cfl) { var arr = []; arr.push(cf); for (var i=0; i < cfl.length; i++) { arr.push(cfl[i][2])}; return arr; };
    var peg$f99 = function(col, f) { return col + f; };
    var peg$f100 = function(col, ff, ft) { return col + ff + ft; };
    var peg$f101 = function() { return "Y"; };
    var peg$f102 = function() { return "G"; };
    var peg$f103 = function() { return "R"; };
    var peg$f104 = function() { return "B"; };
    var peg$f105 = function(col, row) { return col + row; };
    var peg$f106 = function() { return "clk"; };
    var peg$f107 = function() { return "egt"; };
    var peg$f108 = function() { return "emt"; };
    var peg$f109 = function() { return "mct"; };
    var peg$f110 = function(hm, s1, s2, millis) { let ret = s1;
        ...
        return ret; };
    var peg$f111 = function(hm, s1, s2) { let ret = s1;
        if (!hm) { addMessage({ message: `Hours and minutes missing`}) } else { ret = hm + ret }
        if (hm && ((hm.match(/:/g) || []).length == 2)) {
        ...
        if (!s2) { addMessage({ message: `Only 2 digit for seconds normally used`}) } else { ret += s2 }
        return ret; };
    var peg$f112 = function(hours, minutes) { if (!minutes) {
              addMessage({ message: `No hours found`}); return hours }
          return hours + minutes; };
    var peg$f113 = function(h1, h2) { let ret = h1;
        if (h2) {
          ret += h2 + ":";
        } else { ret += ":" }
        return ret; };
    var peg$f114 = function(m1, m2) { let ret = m1;
        if (m2) { ret += m2 + ":"; }
        else { ret += ":"; addMessage({ message: `Only 2 digits for minutes normally used`}) }
        return ret; };
    var peg$f115 = function(d) { return d; };
    var peg$f116 = function(vari, all) { var arr = (all ? all : []); arr.unshift(vari); return arr; };
    var peg$f117 = function(num) { return num; };
    var peg$f118 = function() { return '';};
    var peg$f119 = function(fig, disc, str, col, row, pr, ch) { var hm = {}; hm.fig = (fig ? fig : null); hm.disc =  (disc ? disc : null); hm.strike = (str ? str : null);
        hm.col = col; hm.row = row; hm.check = (ch ? ch : null); hm.promotion = pr;
        hm.notation = (fig ? fig : "") + (disc ? disc : "") + (str ? str : "") + col + row + (pr ? pr : "") + (ch ? ch : "");
        return hm; };
    var peg$f120 = function(fig, cols, rows, str, col, row, pr, ch) { var hm = {}; hm.fig = (fig ? fig : null); hm.strike = (str =='x' ? str : null); hm.col = col; hm.row = row;
        hm.notation = (fig && (fig!=='P') ? fig : "") + cols + rows + (str=='x' ? str : "-") + col  + row + (pr ? pr : "") + (ch ? ch : "");
        hm.check = (ch ? ch : null); hm.promotion = pr; return hm; };
    var peg$f121 = function(fig, str, col, row, pr, ch) { var hm = {}; hm.fig = (fig ? fig : null); hm.strike = (str ? str : null); hm.col = col;
        hm.row = row; hm.check = (ch ? ch : null); hm.promotion = pr;
        hm.notation = (fig ? fig : "") + (str ? str : "") + col  + row + (pr ? pr : "") + (ch ? ch : ""); return hm; };
    var peg$f122 = function(ch) { var hm = {}; hm.notation = 'O-O-O'+ (ch ? ch : ""); hm.check = (ch ? ch : null); return  hm; };
    var peg$f123 = function(ch) { var hm = {}; hm.notation = 'O-O'+ (ch ? ch : ""); hm.check = (ch ? ch : null); return  hm; };
    var peg$f124 = function(fig, col, row) { var hm = {}; hm.fig = fig; hm.drop = true; hm.col = col; hm.row = row; hm.notation = fig + '@' + col + row; return hm; };
    var peg$f125 = function(ch) { return ch[1]; };
    var peg$f126 = function(f) { return '=' + f; };
    var peg$f127 = function(nag, nags) { var arr = (nags ? nags : []); arr.unshift(nag); return arr; };
    var peg$f128 = function(num) { return '$' + num; };
    var peg$f129 = function() { return '$3'; };
    var peg$f130 = function() { return '$4'; };
    var peg$f131 = function() { return '$5'; };
    var peg$f132 = function() { return '$6'; };
    var peg$f133 = function() { return '$1'; };
    var peg$f134 = function() { return '$2'; };
    var peg$f135 = function() { return '$7'; };
    var peg$f136 = function() { return '$10'; };
    var peg$f137 = function() { return '$13'; };
    var peg$f138 = function() { return '$14'; };
    var peg$f139 = function() { return '$15';};
    var peg$f140 = function() { return '$16';};
    var peg$f141 = function() { return '$17';};
    var peg$f142 = function() { return '$18';};
    var peg$f143 = function() { return '$19';};
    var peg$f144 = function() { return '$22'; };
    var peg$f145 = function() { return '$32'; };
    var peg$f146 = function() { return '$36'; };
    var peg$f147 = function() { return '$40'; };
    var peg$f148 = function() { return '$132'; };
    var peg$f149 = function() { return '$220'; };
    ...
    function peg$parsepgn() {
      ...
      if (s6 !== peg$FAILED) {
        ...
        peg$savedPos = s0;
        s0 = peg$f78(s2, s4, s6, s8, s9, s11, s13, s14);
      } else {
        peg$currPos = s0;
        s0 = peg$FAILED;
      }
        ...
        if (s3 !== peg$FAILED) {
          ...
          if (s5 !== peg$FAILED) {
            ...
            if (s6 !== peg$FAILED) {
              ...
              peg$savedPos = s0;
              s0 = peg$f119(s1, s3, s4, s5, s6, s7, s8);
            } else {
              peg$currPos = s0;
              s0 = peg$FAILED;
            }
          ...
          if (s3 !== peg$FAILED) {
            ...
            if (s5 !== peg$FAILED) {
              ...
              if (s6 !== peg$FAILED) {
                ...
                peg$savedPos = s0;
                s0 = peg$f120(s1, s2, s3, s4, s5, s6, s7, s8);
              } else {
                peg$currPos = s0;
                s0 = peg$FAILED;
              }
