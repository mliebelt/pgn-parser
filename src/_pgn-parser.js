...
function peg$parse(input, options) {
  ...
  var peg$e141 = peg$otherExpectation("string");
  ...
  var peg$f58 = function() { return "\x22"; };
  ...
  var peg$f110 = function(c, tail) { if (tail.length > 0) { return merge([{ comment: trimEnd(c.join("")) }].concat(trimStart(tail[0]))) }
  ...
  var peg$f114 = function(cf, cfl) { var arr = []; arr.push(cf); for (var i=0; i < cfl.length; i++) { arr.push(cfl[i][2])}; return arr; };
  ...
  var peg$f123 = function() { return "clk"; };
  var peg$f124 = function() { return "egt"; };
  var peg$f125 = function() { return "emt"; };
  var peg$f126 = function() { return "mct"; };
  ...
  var peg$f131 = function(hm, s1, s2, millis) { let ret = s1;
    ...
    return ret; };
  var peg$f132 = function(hm, s1, s2) { let ret = s1;
    if (!hm) { addMessage({ message: `Hours and minutes missing`}) } else { ret = hm + ret }
    if (hm && ((hm.match(/:/g) || []).length == 2)) {
    ...
    if (!s2) { addMessage({ message: `Only 2 digit for seconds normally used`}) } else { ret += s2 }
    return ret; };
  var peg$f133 = function(hours, minutes) { if (!minutes) {
          addMessage({ message: `No hours found`}); return hours }
      return hours + minutes; };
  var peg$f134 = function(h1, h2) { let ret = h1;
    if (h2) {
      ret += h2 + ":";
    } else { ret += ":" }
    return ret; };
  var peg$f135 = function(m1, m2) { let ret = m1;
    if (m2) { ret += m2 + ":"; }
  ...
  var peg$f141 = function(fig, disc, str, col, row, pr, ch) { var hm = {}; hm.fig = (fig ? fig : null); hm.disc =  (disc ? disc : null); hm.strike = (str ? str : null);
    hm.col = col; hm.row = row; hm.check = (ch ? ch : null); hm.promotion = pr;
    hm.notation = (fig ? fig : "") + (disc ? disc : "") + (str ? str : "") + col + row + (pr ? pr : "") + (ch ? ch : "");
    return hm; };
  var peg$f142 = function(fig, cols, rows, str, col, row, pr, ch) { var hm = {}; hm.fig = (fig ? fig : null); hm.strike = (str =='x' ? str : null); hm.col = col; hm.row = row;
    hm.notation = (fig && (fig!=='P') ? fig : "") + cols + rows + (str=='x' ? str : "-") + col  + row + (pr ? pr : "") + (ch ? ch : "");
    hm.check = (ch ? ch : null); hm.promotion = pr; return hm; };
  var peg$f143 = function(fig, str, col, row, pr, ch) { var hm = {}; hm.fig = (fig ? fig : null); hm.strike = (str ? str : null); hm.col = col;
  ...
  function peg$parseesc_char_check() {
    var s0, s1, s2, s3;
